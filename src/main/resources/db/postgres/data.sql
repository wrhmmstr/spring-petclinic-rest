...
INSERT INTO pets (name, birth_date, owner_id) SELECT 'Leo', '2000-09-07', 1 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=1);
INSERT INTO pets (name, birth_date, owner_id) SELECT 'Basil', '2002-08-06', 2 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=2);
INSERT INTO pets (name, birth_date, owner_id) SELECT 'Rosy', '2001-04-17', 3 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=3);
INSERT INTO pets (name, birth_date, owner_id) SELECT 'Jewel', '2000-03-07', 3 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=4);
INSERT INTO pets (name, birth_date, owner_id) SELECT 'Iggy', '2000-11-30', 4 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=5);
INSERT INTO pets (name, birth_date, owner_id) SELECT 'George', '2000-01-20', 5 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=6);
INSERT INTO pets (name, birth_date, owner_id) SELECT 'Samantha', '1995-09-04', 6 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=7);
INSERT INTO pets (name, birth_date, owner_id) SELECT 'Max', '1995-09-04', 6 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=8);
INSERT INTO pets (name, birth_date, owner_id) SELECT 'Lucky', '1999-08-06', 7 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=9);
INSERT INTO pets (name, birth_date, owner_id) SELECT 'Mulligan', '1997-02-24', 8 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=10);
INSERT INTO pets (name, birth_date, owner_id) SELECT 'Freddy', '2000-03-09', 9 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=11);
INSERT INTO pets (name, birth_date, owner_id) SELECT 'Lucky', '2000-06-24', 10 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=12);
INSERT INTO pets (name, birth_date, owner_id) SELECT 'Sly', '2002-06-08', 10 WHERE NOT EXISTS (SELECT * FROM pets WHERE id=13);
